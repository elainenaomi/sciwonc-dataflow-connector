...
from sciwonc.dataflow import DataStoreClient
from sciwonc.dataflow import DataStoreServer
from sciwonc.dataflow import DataStoreFactory
import ConfigMongoDB

# connector and config
client = DataStoreClient(DataStoreServer, DataStoreFactory,"mongodb", ConfigMongoDB)
